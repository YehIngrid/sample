...
const i18n = {
  zh: {
    ...
    'hero.btn.shop':'立即開始購物','hero.btn.browse':'立即註冊/登入',
    ...
    'faq.title':'常見問題','faq.q':'問','faq.step.label':'步',
    'faq.q1.q':'如何販賣商品？',
    'faq.q1.step01.title':'進入賣家專區','faq.q1.step01.desc':'前往購物首頁，點選主廣告幅下方的賣家專區。',
    'faq.q1.step02.title':'閱讀販賣規則','faq.q1.step02.desc':'請先閱讀商品販賣規則，再點擊「我要賣商品！」進入販賣商品環節。',
    ...
    'faq.q1.step07.title':'上架成功可查看商品','faq.q1.step07.desc':'看到商品上架成功之訊息即可前往首頁確認或點擊「我的帳戶」或頭像（電腦版）前往「帳戶管理中心」點擊「商品管理」查看與編輯。',
    'faq.q2.q':'如何購買商品？',
  ...
  en: {
    ...
    'hero.btn.shop':'Start Shopping','hero.btn.browse':'Sign Up / Login',
    ...
    'faq.title':'FAQ','faq.q':'Q','faq.step.label':'step',
    ...
    'faq.q1.step02.title':'Read Selling Rules','faq.q1.step02.desc':'Read the selling rules first, then click "I Want to Sell!" to proceed.',
    ...
    'faq.q1.step07.title':'Listing Successful','faq.q1.step07.desc':'Once you see the success message, visit the homepage to verify, or click "My Account" / your avatar (desktop) to go to Account Center and check under "Product Management".',
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.querySelectorAll('.nh-member-more').forEach((btn) => {
    btn.addEventListener('click', () => {
      const card = btn.closest('.nh-member');
