import{C as N}from"./ChatBackendService-B7XEl7RX.js";const a=document.getElementById("talkInterface"),_=document.getElementById("chaticon");function L(){return!!document.querySelector(".bottom-nav")}let i=null;function A(){return i||(a?(i=document.createElement("button"),i.id="chatMaxBtn",i.title="全螢幕",i.innerHTML="⛶",i.style.display="none",document.body.appendChild(i),i.addEventListener("click",t=>{t.stopPropagation(),x()}),i):null)}function x(t=!1){var o;if(!a)return;const e=t?!1:!a.classList.contains("maximized");a.classList.toggle("maximized",e),(o=a.contentWindow)==null||o.postMessage({type:e?"maximizeChat":"restoreFromParent"},window.location.origin),i&&(i.classList.toggle("maximized",e),i.innerHTML=e?"⊡":"⛶",i.title=e?"縮小視窗":"全螢幕")}function U(){const t=A();t&&(t.style.display="block")}function E(){i&&(i.style.display="none")}async function $(){if(L()){window.location.href="../chatroom/chatroom.html";return}if(a.style.display==="none"||a.style.display===""){if(!await B()){a.style.display="none";return}(!a.src||a.src==="about:blank"||a.src===window.location.href)&&(a.src="../chatroom/chatroom.html"),a.style.display="block",U()}else a.classList.remove("maximized"),a.style.display="none",E()}window.addEventListener("click",function(t){L()||a&&a.style.display==="block"&&!a.classList.contains("maximized")&&!a.contains(t.target)&&!(_!=null&&_.contains(t.target))&&!document.querySelector(".swal2-container")&&!document.querySelector(".am-backdrop.open")&&(a.style.display="none")});document.addEventListener("keydown",function(t){t.key!=="Escape"||!a||a.style.display==="none"||(a.classList.contains("maximized")?x(!0):(a.style.display="none",E()))});window.addEventListener("message",function(t){var e,o,m;((e=t.data)==null?void 0:e.type)==="closeChat"?(a&&(a.classList.remove("maximized"),a.style.display="none"),E(),document.body.classList.remove("chat-open-mobile")):((o=t.data)==null?void 0:o.type)==="maximizeChat"?x(!1):((m=t.data)==null?void 0:m.type)==="restoreChat"&&x(!0)});async function B(){return!0}const O=5,v=5e3,y=new Map,f=new Map;(function(){if(document.getElementById("chat-toast-style"))return;const e=document.createElement("style");e.id="chat-toast-style",e.textContent=`
