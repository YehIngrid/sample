import{B as T}from"./default-CDa8LL4u.js";import{A as _}from"./app-modal-qdw6XuZO.js";const f=new T,S={},B={},x="../webP/default-avatar.webp";function o(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function A(e){return S[e]??e}function k(e){if(!e)return!0;const s=B[e]??B[e.toLowerCase()];return s!==void 0?s:!0}async function E(){var e,s;if(!(Object.keys(S).length>0))try{const r=await f.getReviewTags();(((s=(e=r==null?void 0:r.data)==null?void 0:e.data)==null?void 0:s.tags)??[]).forEach(a=>{S[a.tag]=a.description??a.meaning,B[a.tag]=a.positive})}catch{}}function U(e,s){var y,b,h,w;const r=((y=e==null?void 0:e.reviewer)==null?void 0:y.name)??(e==null?void 0:e.reviewerName)??"評價者",a=((b=e==null?void 0:e.reviewer)==null?void 0:b.photoURL)??((h=e==null?void 0:e.reviewerUser)==null?void 0:h.photoURL)??x,n=((w=e==null?void 0:e.reviewer)==null?void 0:w.accountId)??"",c=(e==null?void 0:e.id)??"",d=e!=null&&e.createdAt?new Date(e.createdAt).toLocaleDateString("zh-TW"):"",i=(e==null?void 0:e.comment)??"",u=(e==null?void 0:e.commodityName)??"",t=Array.isArray(e==null?void 0:e.tags)?e.tags:[],g=s==="seller"?"賣":s==="buyer"?"買":"",v=s==="seller"?"reviewer-role-badge--seller":"reviewer-role-badge--buyer",$=t.map(C=>`<span class="review-display-chip ${k(C)?"positive":"negative"}">${o(A(C))}</span>`).join("");return`
    ...
    `,showCancelButton:!0,confirmButtonText:"送出檢舉",cancelButtonText:"取消",focusConfirm:!1,preConfirm:()=>{const t=document.getElementById("report-category").value,g=document.getElementById("report-subject").value.trim(),v=document.getElementById("report-detail").value.trim();return t?g?{category:t,subject:g,detail:v}:(Swal.showValidationMessage("請填寫主旨"),!1):(Swal.showValidationMessage("請選擇檢舉類型"),!1)}});if(!(!d||!i))try{if(r){const t=new FormData;t.append("reportedUserId",r),t.append("category",i.category),t.append("subject",i.subject),i.detail&&t.append("detail",i.detail),await f.submitReport(t)}else if(a){const t=new FormData;t.append("reviewId",a),t.append("category",i.category),t.append("subject",i.subject),i.detail&&t.append("detail",i.detail),await f.submitReport(t)}_.fire({icon:"success",title:"檢舉已送出",text:"我們會盡快處理，謝謝你的回報。",timer:2e3,showConfirmButton:!1})}catch{_.fire({icon:"error",title:"送出失敗",text:"請稍後再試"})}}function I(e){e.addEventListener("click",s=>{const r=s.target.closest("[data-report-review-id]");if(r){j({title:"檢舉評價",targetLabel:r.dataset.reportReviewerName,reviewId:r.dataset.reportReviewId,userId:null});return}const a=s.target.closest("[data-report-user-id]");if(a){j({title:"檢舉用戶",targetLabel:a.dataset.reportUserName,userId:a.dataset.reportUserId,reviewId:null});return}const n=s.target.closest("[data-reviewer-id]");if(!n)return;const c=n.dataset.reviewerId,d=n.dataset.reviewerName,i=n.dataset.reviewerPhoto;c&&P(c,d,i)})}async function P(e,s,r){var L,N;await E();let a=null,n=[],c=[],d="",i="NONE",u=0;try{const[p,R]=await Promise.all([f.getUserReviews(e),f.getPublicUserProfile(e).catch(()=>null)]),m=(L=p==null?void 0:p.data)==null?void 0:L.data,l=(N=R==null?void 0:R.data)==null?void 0:N.data;a=(m==null?void 0:m.stats)??null,n=(m==null?void 0:m.sellerReviews)??[],c=(m==null?void 0:m.buyerReviews)??[],d=(l==null?void 0:l.introduction)??"",i=(l==null?void 0:l.suspensionLevel)??"NONE",u=(l==null?void 0:l.lowScoreStrikeCount)??0,!r&&(l!=null&&l.photoURL)&&(r=l.photoURL)}catch{}const t=Number((a==null?void 0:a.reviewCount)??0),g=(a==null?void 0:a.accountScore)??"-",v=t>0?`${t} 則評價 · 信譽積分 ${g}`:"尚無評價紀錄",$=i&&i!=="NONE"?'<span class="rp-badge rp-badge--danger">可疑帳號</span>':"",y=u?`<span class="rp-badge rp-badge--warn">低分紀錄 ${u} 次</span>`:"",b=[...n.map(p=>U(p,"seller")),...c.map(p=>U(p,"buyer"))].join(""),h=b?`<div class="review-list">${b}</div>`:'<div class="review-empty rp-empty"><i class="ti ti-message-circle" style="font-size:1.8rem;display:block;margin-bottom:6px;opacity:0.4;"></i>目前尚無評價紀錄</div>',w=localStorage.getItem("uid"),C=e&&String(e)!==String(w)?`<button class="rp-report-btn" data-report-user-id="${e}" data-report-user-name="${o(s)}">
         <i class="ti ti-flag"></i>檢舉此用戶
       </button>`:"";_.fire({title:!1,customClass:{htmlContainer:"swal-left-body",popup:"rp-modal-popup"},html:`
      <div class="rp-profile">
        <img src="${o(r||x)}" class="rp-avatar" alt="${o(s)}頭像"
          onerror="this.src='${x}'">
        <div class="rp-info">
      ...
      <div class="rp-reviews">${h}</div>
    `,confirmButtonText:"關閉",width:520,didOpen:p=>I(p)})}export{I as b,P as o};
