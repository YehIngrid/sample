...
//                 message: `<img src="${base64Image}" alt="Image" style="max-width: 200px; max-height: 200px;">`,
...
//         imgWrapper.className = `imgmessage ${url.isSelf || url.username === this.username ? 'message-self' : 'message-other'}`;

//         const time = new Date(url.timestamp).toLocaleTimeString('zh-TW', {
//             hour: '2-digit',
//             minute: '2-digit'
//         });

//         imgWrapper.innerHTML = `
//             ${!url.isSelf && url.username !== this.username ? `
//                 <div class="message-avatar">
//                     <i class="bi bi-person-circle"></i>
//                 </div>
//             ` : ''}
//             <div class="message-content">
//                 <div class="message-header ${url.isSelf || url.username === this.username ? 'text-end' : ''}">
//                     ${url.isSelf || url.username === this.username ? `
//                         <small class="text-muted me-2">${time}</small>
//                         <strong>我</strong>
//                     ` : `
//                         <strong>${url.username}</strong>
...
//         img.src = url;
//         img.style.maxWidth = '200px'; // 限制顯示寬度
...
//             // 呼叫顯示函數
//             this.appendImageMessage(imageUrl);
